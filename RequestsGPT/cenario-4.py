...
codigo do produto nomeando como nk_produto
descricao do produto nomeando como ds_produto
embalagem do produto nomeando como ds_embalagem_produto
indicador se o produto esta ou nao ativo, com o tipo de dado booleano, nomeando como bl_produto_inativo
descricao da divisao nomeando como ds_divisao
descricao da seção nomeando como ds_secao
descricao do grupo nomeando como ds_grupo
descricao do subgrupo nomeando como ds_subgrupo
'''
